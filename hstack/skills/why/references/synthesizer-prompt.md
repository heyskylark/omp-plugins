...
The parent applies this template inline; do not spawn a synthesizer. Fill in the placeholders with both child outputs and parent source searches.
...
- **Source control history**: {file paths}, {number of commits reviewed}, PRs #{numbers}, and code comments searched. Or "Not searched: {actual checkout, history, authentication or tool limitation}."
