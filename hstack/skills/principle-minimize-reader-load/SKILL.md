...
**Why:** Code is read far more than it is written. LOC, cyclomatic complexity, and "clean architecture" are proxies. Reader load is the thing that matters. The two axes are independent. A flat file with 50 globals can be as hard to reason about as a 6-layer adapter stack. Guard both. This is the human analog of [Guard the Context Window](skill://principle-guard-the-context-window). Working memory is finite for readers too. Read and apply that skill when managing the corresponding context-window pressure.
