...
The parent applies this template inline; do not spawn a separate explainer. Fill in the placeholders. For a simple question, explore directly and omit the Explorer Findings section.
