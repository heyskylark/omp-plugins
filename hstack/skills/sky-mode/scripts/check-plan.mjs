...
const LANES = "Ten lanes using configured general task agents or explicitly compatible specialists at the PR head";
const SUB_BLOCKS = [
	"Depends on.",
	"Files.",
	"Build.",
...
const PROGRAM_MARKERS = ["parent todo", "local://", /30[- ]minute/, "status message"];
